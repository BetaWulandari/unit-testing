package com.bwrsks.unittesting
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private lateinit var btnCircumference: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnCircumference = findViewById(R.id. btn_calculate_circumference)
    ...
    private fun visible(){
        ...
        btnCircumference.visibility = View.VISIBLE
    ...
    private fun gone(){
        ...
        btnCircumference.visibility = View.GONE
